...
# Datasets
In order to run the code and replicate the data results, first set up a python environment and install all the libraries in requirements.txt. All data can be generated by running generate.py under the transit-equity/datasets folder. Running this python file will create a "data" folder with all csv files inside.
